export const projectsData = [
  {
    ...
    description:
      "A full-stack project management tool designed around developer workflows — with GitHub integration, sprint tracking, and real-time collaboration.",
    bullets: [
  ...
  },
  {
    ...
    name: "CodeSync",
    tagline:
      "Real-time collaborative code editing — like Google Docs for developers.",
    description:
      "A multiplayer code editor with real-time sync, syntax highlighting for 40+ languages, and built-in video calling — zero setup required.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "An open-source React component library focused on micro-animations, accessible design, and developer experience — with a Storybook-powered docs site.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "An intelligent task manager that uses GPT-4 to prioritize your backlog based on deadlines, energy levels, and project impact — so you never waste time deciding.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "A stock portfolio tracker with real-time prices, P&L analysis, sector allocation charts, and AI-powered insights — built for retail investors who care about data.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "A developer-focused desktop note app built with Electron — with a split-pane Markdown editor, code block execution, local-first storage, and instant search.",
    bullets: [
