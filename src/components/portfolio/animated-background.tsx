...
import type { Section } from "./animated-background-config";
...
// Custom local preloader tracking state since we don't use a global preloader context
const usePreloader = () => {
...
const AnimatedBackground = () => {
  ...
  const theme = "dark"; // Target site uses static dark mode
  ...
  // Reveal keyboard on load/route change and sync hash
  useEffect(() => {
