    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(160deg, var(--color-bg) 0%, var(--color-surface) 100%)",
          backgroundImage:
      ...
      >
        ...
        <ellipse
          ...
          rx="14"
          ry="7"
          fill={lampOn ? "#2a2a2a" : "#1e1e1e"}
          style={{ cursor: "pointer" }}
          onClick={handleLampClick}
        />
        {/* Lamp bulb glow when on */}
        {lampOn && (
          <circle cx="120" cy="163" r="4" fill="rgba(255,220,100,0.8)" />
        )}
        {/* Light cone (only when lamp on) */}
        {lampOn && (
          <polygon points="108,170 132,170 148,215 92,215" fill="url(#ll)" />
        )}
        ...
        {/* ── LAYER 2: Body (static) ── */}
        <path
          d="M175 218 L175 165 Q175 155 185 152 L195 148 L210 145 L225 148 L235 152 Q245 155 245 165 L245 218 Z"
        ...
        <path
          d="M185 152 Q175 145 178 135 Q182 125 210 122 Q238 125 242 135 Q245 145 235 152"
          fill="none"
          stroke="#222"
          strokeWidth="1.5"
        />
        ...
        {/* Left arm */}
        <path
          d="M175 175 Q165 185 155 207 L175 207 L180 185 Z"
          fill="var(--color-surface-2)"
        />
        {/* Right arm */}
        <path
          d="M245 175 Q255 185 265 207 L245 207 L240 185 Z"
          fill="var(--color-surface-2)"
        />
        ...
        <g
          style={{
            ...
            animation: isHovered ? "none" : "head-sway 5s ease-in-out infinite",
        ...
        >
          ...
          <path
            d="M328 202 Q338 202 338 210 Q338 218 328 218"
            stroke="#1a1a1a"
            strokeWidth="4"
            fill="none"
            strokeLinecap="round"
          ...
          {/* Steam — layer 7 */}
          <path
            d="M308 194 Q305 188 308 182 Q311 176 308 170"
            stroke="rgba(255,255,255,0.25)"
            strokeWidth="1.5"
            fill="none"
            strokeLinecap="round"
            strokeDasharray="60"
            style={{ animation: "steam-rise 2.5s ease-in-out infinite" }}
          />
          <path
            d="M314 193 Q311 186 314 179 Q317 172 314 165"
