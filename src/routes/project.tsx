      ...
      >
            ...
            >
              ...
              <span
                style={{
                  fontStyle: "italic",
                  background:
                    "linear-gradient(135deg, #7b2fff 0%, #e91e8c 100%)",
        ...
        <div className="projects-masonry">
          {projectsData.map((project) => (
            <div
              key={project.id}
              style={{ breakInside: "avoid", marginBottom: "80px" }}
            >
        ...
        content = (
          <div style={{ padding: "16px", fontFamily: "monospace" }}>
            ...
            >
              ...
              />
              <div
                style={{ width: "2px", height: "12px", background: "#528bff" }}
              />
            </div>
            <div style={{ display: "flex", gap: "8px", marginBottom: "8px" }}>
              <div
            ...
            >
              <div
                style={{
                  ...
                  width: "100%",
                  background:
                    "linear-gradient(90deg, #00b4d822 0%, transparent 100%)",
                }}
              />
            </div>
          </div>
